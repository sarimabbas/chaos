...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    setWorkspaceRootNode(state, node) {
      state.views.workspaceRootNode = node;
      state.views.workspaceRootPath = node.path;
    },
  ...
  actions: {
    ...
    setWorkspaceRootNode(ctx, node) {
      ctx.commit("setWorkspaceRootNode", node);
    },
